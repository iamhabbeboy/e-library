...
<input name="retdate" type="text" value="" placeholder="Type in return date using dd/mm/yyyy e.g <?=date('d/m/Y');?>" required/>
<input name="copies" type="hidden" value="<?=$fetch['copies'];?>"/>
<input name="bookedcopies" type="hidden" value="<?=$fetch['bookedcopies'];?>"/>

<input id="member" name="member" type="hidden" placeholder="Member ID" required value="<?=$_SESSION['nacoss_user'];?>"/>
