...
<input name="retdate" type="text" value="<?=$fetchbk['retdate'];?>" placeholder="Type in return date using dd/mm/yyyy e.g 23/12/200" required readonly/>
<label>Member ID <span>*</span></label>
<input id="member" name="member" type="text" placeholder="Member ID" required value="<?=$fetchbk['memberid'];?>" readonly/>
<?php
